    ...
    */
    ...
    if (TiberiumScan >= MAP_CELL_TOTAL) {
        ...
        */
        ...
        auto growthFactorMultipler = Get_Fixed_Rule(GAME_MAP_SECTION, TIBERIUM_GROWTH_RATE_RULE);
		auto spreadFactorMultipler = Get_Fixed_Rule(GAME_MAP_SECTION, TIBERIUM_SPREAD_RATE_RULE);
